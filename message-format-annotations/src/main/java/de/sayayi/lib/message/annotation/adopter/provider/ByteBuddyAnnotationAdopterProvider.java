...
/**
 * {@link AnnotationAdopterProvider} implementation that creates a {@link ByteBuddyAnnotationAdopter} backed by the
 * ASM library bundled with <a href="https://bytebuddy.net/">Byte Buddy</a>.
 * <p>
 * This provider requires the Byte Buddy library on the classpath. It has an order of {@code 300}.
 *
 * @author Jeroen Gremmen
 * @since 0.24.0
 */
public final class ByteBuddyAnnotationAdopterProvider implements AnnotationAdopterProvider
{
  @Override
  public int order() {
    return 300;
  ...
  public @NotNull AnnotationAdopter createAnnotationAdopter(@NotNull MessageFactory messageFactory,
    ...
    return new ByteBuddyAnnotationAdopter(messageFactory, publisher);
  }
}

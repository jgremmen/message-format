...
import static net.bytebuddy.jar.asm.ClassReader.*;
import static net.bytebuddy.jar.asm.Opcodes.ACC_SYNTHETIC;
import static net.bytebuddy.jar.asm.Opcodes.ASM9;


/**
 * Byte-Buddy ASM-based annotation adopter that scans compiled class files for message and template annotations without
 ...
 * <p>
 * Class files are analyzed with the ASM bytecode library bundled with Byte-Buddy, which means the scanned classes
 * do not need to be on the runtime classpath.
 * <p>
 ...
 * <p>
 * Using this class requires a dependency on the Byte-Buddy library ({@code net.bytebuddy:byte-buddy:1.18.+}).
 *
 * @author Jeroen Gremmen
 * @since 0.8.0
 */
@SuppressWarnings("unused")
public final class ByteBuddyAnnotationAdopter extends AbstractAnnotationAdopter
{
  ...
  static
  {
    var api = ASM9;  // lowest supported version
  ...
  /**
   * Create a Byte Buddy annotation adopter for the given {@code configurableMessageSupport}. The message factory and
   ...
   */
  public ByteBuddyAnnotationAdopter(@NotNull ConfigurableMessageSupport configurableMessageSupport) {
    super(configurableMessageSupport);
  }


  /**
   * Create a Byte Buddy annotation adopter for the given {@code messageFactory} and {@code publisher}. This
   ...
   */
  public ByteBuddyAnnotationAdopter(@NotNull MessageFactory messageFactory, @NotNull MessagePublisher publisher) {

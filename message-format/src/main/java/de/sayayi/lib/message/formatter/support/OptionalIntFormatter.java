 ...
 */
public final class OptionalIntFormatter extends AbstractParameterFormatter implements EmptyMatcher, SizeQueryable
{
                                   ...
                                   @NotNull Parameters parameters, Data data)
  {
    ...
    return messageContext.getFormatter(format, int.class)
        .format(messageContext, optional.getAsInt(), format, parameters, data);
  }
  ...
  public @NotNull Set<Class<?>> getFormattableTypes() {
    return singleton(OptionalInt.class);
  }
}

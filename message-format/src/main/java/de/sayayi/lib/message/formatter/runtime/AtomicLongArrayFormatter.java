 ...
 * @since 0.8.0
 */
public final class AtomicLongArrayFormatter extends AbstractParameterFormatter
    implements EmptyMatcher, SizeQueryable
{
  ...
  public @NotNull Text formatValue(@NotNull FormatterContext context, Object value)
  {
    ...
    if (value != null)
    {
      final AtomicLongArray aia = (AtomicLongArray)value;
  ...
  public @NotNull Set<FormattableType> getFormattableTypes() {
    return singleton(new FormattableType(AtomicLongArray.class));
  }
}

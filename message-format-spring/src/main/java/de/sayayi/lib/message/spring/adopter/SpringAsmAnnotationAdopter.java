 ...
 * <p>
 * The scanned classes are analyzed using the ASM library bundled with Spring. Using this class
 * therefore requires a dependency with library {@code org.springframework:spring-core:}.
 *

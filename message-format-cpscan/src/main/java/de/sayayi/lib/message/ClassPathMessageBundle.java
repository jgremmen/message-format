...
{
  public ClassPathMessageBundle(@NotNull Set<String> packageNames) throws IOException {
    this(packageNames, null);
  }


  public ClassPathMessageBundle(@NotNull Set<String> packageNames, ClassLoader classLoader) throws IOException {
